...
Route::prefix('/panel')->middleware('admin')->group(function () {
    ...
    Route::resource('/roles', \App\Http\Controllers\Panel\RoleController::class)->names('panel.roles');
    Route::resource('/permissions', \App\Http\Controllers\Panel\PermissionController::class)->names('panel.permissions');
});
