...
var lastOpenPDatePicker = !1, lastOpenPDateMonthYearID = !1, pDatePickerZIndex = 99999,
...
AMIB.persianCalendar.prototype.showHidePicker = function (b) {
    ...
    if (c = A$(a)) {
        ...
        this.setMenuPos(c,
            d);
        c.style.zIndex = !lastOpenPDatePicker ? pDatePickerZIndex = 99999 : ++pDatePickerZIndex;
